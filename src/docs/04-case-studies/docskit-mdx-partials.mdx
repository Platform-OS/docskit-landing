...
<Grid cols="3">
  <Card variant="feature" shadow hoverable icon={icon1}>
  ...
  <Card variant="feature" shadow hoverable icon={icon2}>
    #### Ensure consistency
  ...
  <Card variant="feature" shadow hoverable icon={icon3}>
...
The reusable content parts are written in MDX and rendered the very same way using the same [formatting options](/user-guide/markdown/) and [custom components](/user-guide/components/) as any other part of the site.
