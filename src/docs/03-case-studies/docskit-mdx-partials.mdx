---
title: Single sourcing content with DocsKit Partials
...
# Single sourcing content with DocsKit Partials
...
**Solutions:** Facilitating the process of single sourcing by creating a centralized reusable content library.  
...
<Grid cols="3">
  <Card variant="feature" shadow icon={icon1}>
    ...
    Allow writers to compile a library of reusable content, facilitating single sourcing of paragraphs, images, or entire chapters to reduce the need to recreate the same content in multiple places and save time.
  </Card>
