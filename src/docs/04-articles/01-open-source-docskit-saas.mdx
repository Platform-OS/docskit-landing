...
<Grid>
  <Card variant="gradient">
    **Join our free Docs as Code course**
    ...
    <Button href="/docs-as-code-course">Sign up</Button>
  </Card>
  <Card variant="gradient">
    **Schedule a discovery call**
    ...
    <Button href="https://calendar.thetrackapp.com/colin-frost/5939f8d5-c49e-4626-9e70-3f51aa599dcd">Schedule a call</Button>
  </Card>
</Grid>
