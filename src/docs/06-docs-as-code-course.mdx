...
<Message variant="warning" filled>
  **Coming soon: Registration opens shortly!**   
  Stay tuned for updates on our Docs as Code Fundamentals course starting in December. Registration details will be available soon. 
</Message>
