...
description: Embark on a comprehensive learning journey with our Docs as Code Fundamentals course. Designed for beginners and those looking to solidify their understanding, this course delves into the well-established methodology of Docs as Code.
---
...
`video: https://www.youtube.com/watch?v=CP3IHQ6Ltdo`

<Grid>
  <Card>
    <Button href="/user/register">Sign up to join the course.</Button>
  </Card>
  <Card>
    <Button href="/user/login">Already signed up? Log in to access course content.</Button>
  </Card>
</Grid>
