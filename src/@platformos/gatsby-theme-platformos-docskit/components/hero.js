  ...
  <div className="not-prose flex max-w-screen-xl px-4 pb-8 mx-auto gap-2 items-center hero">
      <div className="mr-auto place-self-center flex-1">
          <h1 className="max-w-2xl mb-4 text-4xl leading-none md:text-5xl text-prominent font-bold">
            Welcome to <br /><span className="text-interactive-text">platformOS</span> DocsKit
          </h1>

          <h2 className="max-w-2xl mb-6 font-light text-prominent lg:mb-8 md:text-lg lg:text-xl">
